...
"Physics": {
"Conceptual clarity": [
"Demonstrates an excellent understanding of concepts and is able to grasp even difficult subject matter with ease.",
"Has a strong grasp of the subject matter and demonstrates good conceptual clarity across topics.",
"Has a sound understanding of the basic concepts but needs to develop greater depth and clarity in the finer details.",
"Understands the main concepts but tends to get confused when dealing with finer details and nuances.",
"Needs to strengthen conceptual understanding through thorough reading, regular revision and reinforcement of the basic concepts.",
],
"Reasoning & application": [
"Applies concepts confidently to analyse unfamiliar situations and solve higher-order reasoning problems.",
"Demonstrates strong analytical thinking and applies concepts effectively in reasoning-based questions.",
"Applies concepts accurately in most reasoning questions and shows sound logical thinking.",
"Can apply concepts to familiar situations but needs greater confidence with analytical and unfamiliar problems.",
"Needs more practice in applying concepts logically to reasoning questions and real-life situations.",
"Requires structured guidance to analyse problems and apply concepts effectively in reasoning-based questions.",
],
"Numericals & calculations": [
"Solves numerical problems confidently and systematically, selecting the appropriate formula and applying it accurately.",
"Demonstrates a good approach to numerical problems and generally arrives at accurate solutions with appropriate working.",
"Understands the method for solving numerical problems but occasionally makes errors in substitution or calculation.",
"Can identify the relevant formula but needs greater accuracy when substituting values and carrying out calculations.",
"Needs regular practice in solving numerical problems and developing a systematic approach to calculations.",
"Requires support in identifying the appropriate formula and following the steps needed to solve numerical problems.",
"Needs to be more careful with SI units and conversions while solving numerical problems.",
"Solves numerical problems well but needs to guard against careless errors in calculations, units and conversions.",
],
"Graphs": [
"Interprets and analyses graphs accurately, drawing appropriate conclusions from the information presented.",
"Demonstrates a strong understanding of graphical relationships and uses graphs effectively to analyse physical situations.",
"Reads and interprets graphs correctly but needs to develop greater confidence in analysing more complex graphical relationships.",
"Can extract basic information from graphs but needs to improve the interpretation and analysis of graphical data.",
"Needs more practice in identifying trends, relationships and significant features from graphs.",
"Requires guidance to read graphs correctly and connect the information presented with the underlying physical concepts.",
],
"Diagrams & labelling": [
"Draws accurate, well-structured diagrams and ray diagrams with clear and appropriate labelling.",
"Demonstrates good diagrammatic skills and presents diagrams neatly with the required details and labels.",
"Draws generally correct diagrams but needs greater attention to accuracy, proportion and finer details.",
"Understands the required diagrams but needs to improve the accuracy and clarity of their representation.",
"Needs to improve diagrammatic skills and practise drawing diagrams and ray diagrams more accurately.",
"Needs to pay greater attention to neat and complete labelling so that diagrams communicate the required information clearly.",
],
"Scientific terms & definitions": [
"Uses scientific terminology accurately and gives precise definitions and explanations.",
"Recalls laws and definitions accurately and uses appropriate scientific terms in written responses.",
"Demonstrates good knowledge of laws and definitions but needs to use scientific terminology more precisely in explanations.",
"Understands the underlying concepts but needs to recall important laws and definitions more accurately.",
"Needs to learn key laws and definitions carefully and reproduce them with greater accuracy.",
"Needs to use more appropriate scientific and technical terms to make explanations precise and concise.",
"Needs to strengthen both the recall of laws and definitions and the use of appropriate scientific terminology in answers.",
],
"Class participation & work": [
"Participates proactively in class discussions, responds confidently and demonstrates keen interest in the subject.",
"Is attentive and engaged in class, contributes relevant responses and completes work thoroughly and consistently.",
"Participates well in class discussions and is willing to clarify doubts and seek further understanding.",
"Is attentive in class but could contribute more frequently and volunteer responses with greater confidence.",
"Usually responds when prompted but needs to take greater initiative in participating in class discussions.",
"Has limited classroom participation and needs to engage more actively in discussions and learning activities.",
"Completes written work but needs to pay greater attention to presentation, detail and thoroughness.",
"Needs to be more consistent with written work, as incomplete or rushed work can lead to important details being missed.",
],
"Revision & improvement": [
"Regular revision and continued practice will help consolidate concepts and maintain a strong level of performance.",
"Needs to follow a structured study and revision plan to strengthen areas of weakness and improve consistency.",
"Needs more regular revision of previously covered concepts to avoid gaps and strengthen understanding.",
"Should practise a wider range of numerical and application-based questions to improve confidence and problem-solving ability.",
"Needs to revise topics in greater detail, paying attention to finer points and key information that may be missed in answers.",
"Regular practice of previous years' questions will help strengthen application skills and prepare more effectively for assessments.",
],
},
