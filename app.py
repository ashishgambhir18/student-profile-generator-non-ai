...
Subject: {subject}.
{pronoun_note}
The first sentence MUST begin with the word STUDENT. Use STUDENT only in the first sentence; every later sentence must use the correct pronouns (He/She, his/her, him/her) and must NOT repeat the student's name.
...
if st.session_state.stage == "upload":
    ...
    if st.session_state.generated:
        ...
        # Do not give this widget a session-state key. Streamlit can otherwise
        # retain an old widget value and ignore the newly generated `value`.
        # The profile variable is already the authoritative generated result.
        st.text_area(
            "Profile",
            value=profile or "",
            height=170,
