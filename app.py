...
if st.session_state.stage == "upload":
    ...
    if st.session_state.generated:
        ...
        # Use a versioned widget key so an AI-updated draft replaces the old
        # text-area value after st.rerun(). Streamlit otherwise preserves the
        # previous widget state and can keep displaying the old profile.
        draft_key = f"profile_editor_{i}_{subject}_{st.session_state.draft_version}"
        draft = st.text_area(
            "Profile",
